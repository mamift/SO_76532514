...
<System.CodeDom.Compiler.GeneratedCodeAttribute("xsd", "4.8.3928.0"),
    ...
    Partial Public Class PathDetailsMessage
        ...
        <System.Xml.Serialization.XmlElementAttribute(Order:=1)>
        Public MessageStatus As MessageStatus


        <System.Xml.Serialization.XmlElementAttribute(Order:=2)>
        Public TypeOfRequest As Short


    <System.Xml.Serialization.XmlIgnoreAttribute()>
    Public TypeOfRequestSpecified As Boolean


    <System.Xml.Serialization.XmlElementAttribute(Order:=3)>
        Public TypeOfInformation As TypeOfInformation


    <System.Xml.Serialization.XmlIgnoreAttribute()>
    Public TypeOfInformationSpecified As Boolean


    <System.Xml.Serialization.XmlElementAttribute(Order:=4)>
        Public AdministrativeContactInformation As AdministrativeContactInformation


    <System.Xml.Serialization.XmlElementAttribute(Form:=System.Xml.Schema.XmlSchemaForm.Qualified, Order:=5)>
    Public Identifiers As PathDetailsMessageIdentifiers


    <System.Xml.Serialization.XmlElementAttribute(Form:=System.Xml.Schema.XmlSchemaForm.Qualified, Order:=6)>
    Public PathInformation As PathDetailsMessagePathInformation


    <System.Xml.Serialization.XmlElementAttribute(Order:=7)>
        Public CFRTrainInfo As CFRTrainInfo
    End Class
...
Partial Public Class PathDetailsMessagePathInformation
    ...
    <System.Xml.Serialization.XmlElementAttribute("PlannedJourneyLocation", Order:=0)>
    Public PlannedJourneyLocation() As PlannedJourneyLocation


    <System.Xml.Serialization.XmlElementAttribute(Order:=1)>
    Public PlannedCalendar As PlannedCalendar
End Class
